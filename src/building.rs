...
impl Building {
    ...
    pub fn start(
        ...
        let (building_cmd_tx, building_cmd_rx) = mpsc::channel(100);
        let (driver_cmd_tx, driver_cmd_rx) = mpsc::channel(100);
    ...
    pub(crate) fn num_elevators(&self) -> usize {
        self.elevators.len()
    }

    pub(crate) fn num_floors(&self) -> usize {
        self.floors.len()
    }
}
